...
describe("MealPlan redux 2", () => {
    ...
    it("returns correct result", async () => {
        ...
        expect(MealPlan.sendShoppingItems.mock).toBeTruthy();
...
describe("MealPlan redux 2", () => {
    ...
    beforeEach(() => {
      ...
      MealPlan.getMeals = jest.fn()        
        const getMealsBtn = await screen.findByTestId(/getMealsBtn/i)
        fireEvent.click(getMealsBtn)
      expect(MealPlan.getMeals.mock).toBeTruthy();
    
    });
    it("returns correct result submitMeal", async () => {
        MealPlan.submitMealPlan = jest.fn()        
          const submitMeal = await screen.findByTestId(/submitMeal/i)
          fireEvent.click(submitMeal)
        expect(MealPlan.submitMealPlan.mock).toBeTruthy();
      });
})
describe("MealPlan redux 2", () => {
    const navigate = jest.fn();
    beforeEach(() => {
        ...
        renderWithProviders(<MealPlan />, {
            reduxState: {
              ...
              user_budget: { breakfast: 0.5, lunch: 2, dinner: 2, snack: 2, dessert: 2 },
              user_meals: { breakfast: true, lunch: true, dinner: true, snack: true, dessert: true },
